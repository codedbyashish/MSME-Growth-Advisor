  ...
  return (
    <AuthLayout>
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between text-xs pt-1">
            <label className={`flex items-center space-x-2 cursor-pointer select-none ${
              ...
              <input
                ...
                onChange={handleChange}
                className="w-4 h-4 rounded border-[#243247] bg-[#0B1220] text-[#10B981] focus:ring-[#10B981]"
              />
        ...
        {/* Footer Link */}
        <p className={`text-xs text-center pt-2 ${isDark ? 'text-[#94A3B8]' : 'text-slate-600'}`}>
          Don't have an account?{' '}
          <Link to="/register" className="font-bold text-[#10B981] hover:underline">
            Create an account
          </Link>
        </p>
