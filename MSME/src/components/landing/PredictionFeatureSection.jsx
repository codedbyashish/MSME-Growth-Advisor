        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className={`inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full text-xs font-semibold tracking-wide border ${
              isDark ? 'bg-[#111B2E] text-[#10B981] border-[#243247]' : 'bg-emerald-50 text-emerald-700 border border-emerald-200'
            }`}>
            ...
            <div className={`p-5 rounded-2xl border flex items-center justify-between shadow-lg ${
              isDark ? 'bg-[#111B2E] border-[#243247]' : 'bg-white border-emerald-200 shadow-slate-200/80'
            }`}>
              <div>
                ...
                <div className="flex items-baseline space-x-2 mt-1">
                  ...
                  <span className="text-xs font-bold text-[#10B981] bg-[#10B981]/10 px-2 py-0.5 rounded-full border border-[#10B981]/20 flex items-center gap-1">
                    <TrendingUp className="w-3 h-3" /> Growing
                  </span>
                </div>
              </div>

              <div className="w-12 h-12 rounded-xl bg-[#10B981]/10 border border-[#10B981]/30 text-[#10B981] flex items-center justify-center font-bold text-lg">
                ↑ 14%
              </div>
            </div>
          ...
          <div className="lg:col-span-7">
            <div className={`rounded-2xl border p-6 shadow-2xl transition-all ${
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition-all ${
                      selectedHorizon === '30days'
                        ? 'bg-[#10B981] text-[#0B1220] font-bold shadow'
              ...
              <div className="flex items-center space-x-6 text-xs mb-4">
                ...
                <div className="flex items-center space-x-2">
                  <span className="w-3.5 h-1 bg-[#10B981] rounded-full inline-block border border-dashed border-[#10B981]" />
                  <span className="text-[#10B981] font-semibold">Predicted Sales (AI Forecast)</span>
                </div>
              </div>
              ...
              <div className="h-64 w-full relative pt-2">
                <svg className="w-full h-full overflow-visible" viewBox="0 0 500 180" preserveAspectRatio="none">
                  ...
                  <line x1="280" y1="10" x2="280" y2="160" stroke="#10B981" strokeDasharray="4 4" strokeWidth="1.5" />
                  <text x="285" y="25" fill="#10B981" fontSize="10" fontWeight="bold">Today</text>
                  ...
                  {/* Dashed Prediction Line (June - August) -> Primary green #10B981 */}
                  <path
                  ...
                  <circle cx="280" cy="85" r="6" fill="#10B981" stroke="#ffffff" strokeWidth="2" />
                  <circle cx="350" cy="65" r="5" fill="#10B981" />
                  <circle cx="420" cy="40" r="5" fill="#10B981" />
                  <circle cx="500" cy="25" r="6" fill="#10B981" stroke="#ffffff" strokeWidth="2" />
                </svg>
              </div>
              ...
              <div className={`flex justify-between items-center text-xs pt-3 border-t ${
                ...
                <span>Mar (₹52k)</span>
                <span>Apr (₹58k)</span>
                <span className="font-bold text-[#10B981]">May (₹61k)</span>
                <span className="font-bold text-[#10B981]">Jun (₹65k)</span>
                <span className="font-bold text-[#10B981]">Jul (₹70k)</span>
              </div>
              ...
              <div className={`mt-4 p-3 rounded-xl flex items-center space-x-2 text-[11px] ${
                ...
                <AlertCircle className="w-4 h-4 text-[#10B981] shrink-0" />
                <span>
