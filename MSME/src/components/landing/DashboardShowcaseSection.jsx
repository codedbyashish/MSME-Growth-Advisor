      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-10 p-3.5 sm:p-4 rounded-2xl bg-[#111B2E] border border-[#243247] text-center shadow-lg">
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm font-extrabold tracking-wide uppercase">
            ...
            <ArrowRight className="w-3.5 h-3.5 text-[#10B981]" />
            <span className="text-[#10B981] font-black">GROWTH 📈</span>
          </div>
        </div>
        ...
        <div className={`rounded-3xl border shadow-2xl overflow-hidden transition-all ${
          ...
          <div className="p-4 border-b border-[#243247] flex flex-wrap items-center justify-between gap-4 bg-[#111B2E]">
            ...
            <div className="flex items-center space-x-3 text-xs">
              <span className="text-[#10B981] font-semibold bg-[#10B981]/10 px-2.5 py-1 rounded-md border border-[#10B981]/30">
                Live Data Connected
              </span>
              <button
                onClick={onStart}
                className="px-3.5 py-1.5 rounded-lg bg-[#10B981] hover:bg-[#0ea371] text-[#0B1220] font-bold transition-all cursor-pointer shadow-sm"
              >
                Launch Demo
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className={`p-5 rounded-2xl border ${isDark ? 'bg-[#111B2E] border-[#243247]' : 'bg-slate-50 border-slate-200'}`}>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[10px] bg-[#10B981]/10 text-[#10B981] font-bold px-2 py-0.5 rounded-full border border-[#10B981]/20">
                    Next Month
                  </span>
                </div>
              ...
              <div className={`p-5 rounded-2xl border ${isDark ? 'bg-[#111B2E] border-[#243247]' : 'bg-slate-50 border-slate-200'}`}>
                ...
                <div className="flex items-baseline space-x-2 mb-1">
                  <span className="text-2xl font-black text-[#10B981]">82</span>
                  <span className={`text-xs ${isDark ? 'text-[#64748B]' : 'text-slate-400'}`}>/ 100</span>
                  <span className="text-xs font-bold text-[#10B981] bg-[#10B981]/10 px-2 py-0.5 rounded-full ml-auto border border-[#10B981]/20">
                    Healthy
                  </span>
                </div>
                <p className={`text-xs ${isDark ? 'text-[#94A3B8]' : 'text-slate-600'}`}>
                ...
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className={`divide-y ${isDark ? 'divide-[#243247]' : 'divide-slate-200'}`}>
                    <tr>
                      ...
                      <td className="py-2.5 text-[#10B981] font-semibold">Sales Revenue</td>
                      <td className="py-2.5 font-bold text-right text-[#10B981]">+₹18,500</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="py-2.5 text-[#10B981] font-semibold">Sales Revenue</td>
                      <td className="py-2.5 font-bold text-right text-[#10B981]">+₹24,100</td>
                    </tr>
                  </tbody>
                </table>
              </div>
